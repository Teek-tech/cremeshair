            ...
            <div>
              <form action="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control col-md-6" name="product-name" placeholder="Product name">
                </div>

                <div class="form-group">
                  <label for="product-color">Product Color</label>
                  <input type="text" class="form-control col-md-6" name="product-color" placeholder="product color">
                </div>

                <div class="form-group">
                  <label for="product-size">Product Size</label>
                  <input type="text" class="form-control col-md-6" name="product-size" placeholder="product size">
                </div>

                <div class="form-group">
                  <label for="product-weight">Product weight</label>
                  <input type="text" class="form-control col-md-6" name="product-weight" placeholder="product weight">
                </div>

                <div class="form-group">
                  <label for="product-length">Product length</label>
                  <input type="text" class="form-control col-md-6" name="product-length" placeholder="product lenght">
                </div>
