            ...
            <div>
              <form action="">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control col-md-6" name="company-address" placeholder="company's address">
                </div>

                <div class="form-group">
                  <label for="company-phone">Phone Number</label>
                  <input type="tel" name="company-phone" class="form-control col-md-6" placeholder="company's phone number">
                </div>
